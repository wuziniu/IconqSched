...
where
	...
	and p_size in (8, 10, 30, 41, 22, 17, 24, 14)
...
where
	...
	and p_size in (47, 20, 30, 9, 16, 37, 11, 23)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_size in (3, 33, 8, 4, 37, 25, 46, 45)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_size in (13, 37, 19, 28, 47, 8, 50, 46)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_type not like 'LARGE BRUSHED%'
	and p_size in (13, 10, 28, 45, 30, 41, 24, 11)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_size in (30, 41, 2, 25, 28, 45, 14, 8)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_type not like 'PROMO BRUSHED%'
	and p_size in (7, 50, 43, 34, 39, 48, 41, 32)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_size in (40, 22, 18, 26, 41, 20, 29, 14)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#55'
	and p_type not like 'SMALL ANODIZED%'
	and p_size in (30, 26, 12, 15, 40, 39, 5, 18)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_size in (43, 38, 35, 29, 1, 34, 4, 11)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_size in (24, 10, 38, 50, 21, 48, 31, 37)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#44'
	and p_type not like 'LARGE BRUSHED%'
	and p_size in (22, 35, 26, 19, 21, 36, 5, 24)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_size in (34, 15, 38, 9, 14, 2, 46, 3)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
from
	(
		...
		where
			...
			and c_nationkey = n2.n_nationkey
			and (
				(n1.n_name = 'VIETNAM' and n2.n_name = 'VIETNAM')
				or (n1.n_name = 'VIETNAM' and n2.n_name = 'VIETNAM')
			)
			and l_shipdate between date '1995-01-01' and date '1996-12-31'
	) as shipping
group by
...
where
	...
	and p_size in (49, 16, 45, 24, 28, 41, 5, 12)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_size in (42, 22, 43, 36, 19, 14, 47, 49)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_size in (50, 1, 41, 18, 36, 33, 37, 35)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#34'
	and p_type not like 'SMALL PLATED%'
	and p_size in (16, 46, 21, 13, 39, 11, 8, 14)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_size in (2, 39, 3, 9, 47, 19, 15, 10)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_size in (20, 16, 42, 32, 4, 13, 1, 41)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#41'
	and p_type not like 'STANDARD POLISHED%'
	and p_size in (44, 25, 9, 43, 40, 20, 27, 45)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_size in (27, 35, 8, 42, 25, 33, 15, 40)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#23'
	and p_type not like 'STANDARD BURNISHED%'
	and p_size in (38, 39, 12, 7, 50, 16, 5, 31)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_size in (40, 12, 29, 22, 7, 14, 41, 47)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#53'
	and p_type not like 'STANDARD BURNISHED%'
	and p_size in (25, 11, 24, 13, 27, 17, 19, 10)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_size in (24, 4, 35, 46, 34, 18, 6, 49)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#25'
	and p_type not like 'LARGE BRUSHED%'
	and p_size in (28, 14, 21, 7, 17, 13, 41, 36)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#24'
	and p_type not like 'ECONOMY POLISHED%'
	and p_size in (11, 26, 35, 40, 13, 34, 36, 17)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_size in (40, 15, 4, 19, 34, 28, 13, 39)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
from
	(
		...
		where
			...
			and c_nationkey = n2.n_nationkey
			and (
				(n1.n_name = 'ETHIOPIA' and n2.n_name = 'ETHIOPIA')
				or (n1.n_name = 'ETHIOPIA' and n2.n_name = 'ETHIOPIA')
			)
			and l_shipdate between date '1995-01-01' and date '1996-12-31'
	) as shipping
group by
...
where
	...
	and p_size in (1, 43, 13, 39, 6, 35, 7, 2)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_size in (33, 37, 29, 27, 41, 39, 21, 34)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_size in (23, 29, 46, 40, 39, 38, 30, 32)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#52'
	and p_type not like 'MEDIUM PLATED%'
	and p_size in (21, 42, 14, 28, 44, 31, 48, 5)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#24'
	and p_type not like 'LARGE ANODIZED%'
	and p_size in (9, 26, 46, 7, 33, 1, 50, 2)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#25'
	and p_type not like 'LARGE ANODIZED%'
	and p_size in (50, 23, 30, 28, 15, 41, 46, 16)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_size in (45, 40, 41, 21, 9, 32, 8, 7)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_size in (40, 44, 11, 30, 26, 22, 6, 49)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#12'
	and p_type not like 'MEDIUM BURNISHED%'
	and p_size in (10, 6, 45, 42, 5, 4, 27, 24)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#25'
	and p_type not like 'LARGE POLISHED%'
	and p_size in (26, 8, 16, 3, 17, 40, 20, 37)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#24'
	and p_type not like 'STANDARD POLISHED%'
	and p_size in (46, 3, 34, 26, 33, 23, 47, 4)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_size in (10, 4, 32, 2, 42, 16, 45, 15)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_size in (20, 27, 9, 17, 35, 22, 1, 34)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#52'
	and p_type not like 'SMALL POLISHED%'
	and p_size in (5, 50, 36, 45, 2, 27, 20, 3)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
from
	(
		...
		where
			...
			and c_nationkey = n2.n_nationkey
			and (
				(n1.n_name = 'MOROCCO' and n2.n_name = 'MOROCCO')
				or (n1.n_name = 'MOROCCO' and n2.n_name = 'MOROCCO')
			)
			and l_shipdate between date '1995-01-01' and date '1996-12-31'
	) as shipping
group by
...
where
	...
	and p_brand <> 'Brand#52'
	and p_type not like 'ECONOMY ANODIZED%'
	and p_size in (44, 41, 47, 49, 34, 43, 3, 22)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#44'
	and p_type not like 'MEDIUM BRUSHED%'
	and p_size in (29, 9, 8, 46, 20, 28, 33, 7)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#33'
	and p_type not like 'MEDIUM PLATED%'
	and p_size in (46, 1, 9, 37, 10, 28, 21, 17)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#15'
	and p_type not like 'STANDARD POLISHED%'
	and p_size in (34, 2, 3, 49, 31, 17, 28, 4)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#33'
	and p_type not like 'LARGE POLISHED%'
	and p_size in (24, 5, 45, 22, 40, 16, 41, 27)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#13'
	and p_type not like 'STANDARD PLATED%'
	and p_size in (2, 34, 8, 21, 25, 46, 19, 45)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#11'
	and p_type not like 'SMALL ANODIZED%'
	and p_size in (7, 6, 19, 28, 23, 39, 38, 45)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#31'
	and p_type not like 'SMALL PLATED%'
	and p_size in (36, 27, 28, 38, 11, 45, 33, 48)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#11'
	and p_type not like 'SMALL POLISHED%'
	and p_size in (40, 5, 10, 50, 2, 26, 7, 37)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#24'
	and p_type not like 'MEDIUM BURNISHED%'
	and p_size in (36, 46, 40, 11, 45, 47, 27, 33)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
from
	(
		...
		where
			...
			and c_nationkey = n2.n_nationkey
			and (
				(n1.n_name = 'GERMANY' and n2.n_name = 'GERMANY')
				or (n1.n_name = 'GERMANY' and n2.n_name = 'GERMANY')
			)
			and l_shipdate between date '1995-01-01' and date '1996-12-31'
	) as shipping
group by
...
where
	...
	and p_brand <> 'Brand#33'
	and p_type not like 'MEDIUM BURNISHED%'
	and p_size in (50, 11, 35, 37, 4, 16, 2, 21)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#13'
	and p_type not like 'STANDARD BURNISHED%'
	and p_size in (20, 1, 28, 8, 14, 47, 6, 23)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#12'
	and p_type not like 'PROMO ANODIZED%'
	and p_size in (28, 29, 17, 32, 44, 21, 50, 34)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#51'
	and p_type not like 'STANDARD PLATED%'
	and p_size in (21, 15, 34, 30, 6, 25, 46, 26)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_size in (49, 18, 36, 46, 34, 45, 41, 17)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
from
	(
		...
		where
			...
			and c_nationkey = n2.n_nationkey
			and (
				(n1.n_name = 'INDONESIA' and n2.n_name = 'INDONESIA')
				or (n1.n_name = 'INDONESIA' and n2.n_name = 'INDONESIA')
			)
			and l_shipdate between date '1995-01-01' and date '1996-12-31'
	) as shipping
group by
...
where
	...
	and p_brand <> 'Brand#53'
	and p_type not like 'SMALL ANODIZED%'
	and p_size in (40, 39, 2, 37, 5, 6, 30, 50)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#22'
	and p_type not like 'LARGE POLISHED%'
	and p_size in (4, 17, 40, 31, 33, 1, 10, 49)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#14'
	and p_type not like 'ECONOMY PLATED%'
	and p_size in (16, 32, 28, 30, 12, 26, 36, 15)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#54'
	and p_type not like 'STANDARD BRUSHED%'
	and p_size in (9, 10, 21, 45, 15, 24, 33, 22)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#13'
	and p_type not like 'STANDARD PLATED%'
	and p_size in (13, 25, 28, 16, 2, 43, 26, 19)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_size in (13, 2, 32, 12, 40, 44, 3, 49)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_size in (40, 19, 39, 46, 48, 16, 15, 50)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#15'
	and p_type not like 'STANDARD BRUSHED%'
	and p_size in (11, 46, 22, 4, 14, 29, 5, 1)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#22'
	and p_type not like 'MEDIUM BRUSHED%'
	and p_size in (4, 21, 39, 6, 25, 50, 34, 7)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#11'
	and p_type not like 'MEDIUM PLATED%'
	and p_size in (43, 28, 12, 15, 6, 9, 36, 30)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#34'
	and p_type not like 'MEDIUM ANODIZED%'
	and p_size in (14, 3, 48, 5, 15, 50, 2, 44)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#35'
	and p_type not like 'ECONOMY ANODIZED%'
	and p_size in (12, 25, 36, 39, 28, 35, 3, 30)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#41'
	and p_type not like 'STANDARD BURNISHED%'
	and p_size in (8, 40, 37, 32, 50, 14, 5, 43)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#34'
	and p_type not like 'MEDIUM BURNISHED%'
	and p_size in (18, 29, 31, 38, 43, 26, 1, 36)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#43'
	and p_type not like 'SMALL POLISHED%'
	and p_size in (28, 40, 37, 14, 9, 34, 22, 27)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#33'
	and p_type not like 'ECONOMY POLISHED%'
	and p_size in (47, 1, 31, 30, 23, 25, 45, 20)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#43'
	and p_type not like 'MEDIUM BURNISHED%'
	and p_size in (9, 15, 47, 44, 33, 43, 36, 20)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#34'
	and p_type not like 'MEDIUM BURNISHED%'
	and p_size in (19, 22, 46, 38, 37, 8, 50, 31)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#41'
	and p_type not like 'ECONOMY ANODIZED%'
	and p_size in (9, 11, 2, 22, 33, 6, 36, 4)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#43'
	and p_type not like 'ECONOMY BURNISHED%'
	and p_size in (9, 16, 48, 32, 29, 37, 21, 31)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_size in (7, 23, 49, 24, 33, 26, 5, 10)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#31'
	and p_type not like 'SMALL PLATED%'
	and p_size in (14, 24, 34, 22, 38, 11, 36, 29)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#25'
	and p_type not like 'LARGE ANODIZED%'
	and p_size in (1, 26, 18, 41, 38, 46, 14, 10)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#33'
	and p_type not like 'LARGE ANODIZED%'
	and p_size in (20, 42, 17, 50, 22, 31, 15, 39)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#33'
	and p_type not like 'STANDARD ANODIZED%'
	and p_size in (23, 46, 20, 40, 30, 31, 24, 33)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#32'
	and p_type not like 'LARGE BURNISHED%'
	and p_size in (45, 40, 7, 9, 42, 50, 2, 4)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#22'
	and p_type not like 'LARGE ANODIZED%'
	and p_size in (14, 43, 18, 23, 31, 1, 12, 32)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#11'
	and p_type not like 'ECONOMY ANODIZED%'
	and p_size in (30, 15, 41, 21, 10, 43, 31, 6)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#54'
	and p_type not like 'PROMO ANODIZED%'
	and p_size in (22, 38, 33, 18, 15, 48, 2, 36)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#51'
	and p_type not like 'PROMO POLISHED%'
	and p_size in (18, 33, 38, 30, 39, 12, 45, 7)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#12'
	and p_type not like 'STANDARD POLISHED%'
	and p_size in (13, 41, 35, 42, 34, 25, 6, 50)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#34'
	and p_type not like 'MEDIUM PLATED%'
	and p_size in (15, 3, 30, 9, 17, 18, 47, 36)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#41'
	and p_type not like 'LARGE POLISHED%'
	and p_size in (7, 15, 38, 40, 45, 20, 48, 50)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#45'
	and p_type not like 'SMALL BRUSHED%'
	and p_size in (48, 2, 22, 7, 11, 29, 4, 42)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#15'
	and p_type not like 'PROMO BURNISHED%'
	and p_size in (46, 14, 49, 45, 2, 36, 22, 30)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#41'
	and p_type not like 'PROMO PLATED%'
	and p_size in (17, 1, 35, 9, 21, 11, 31, 26)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#32'
	and p_type not like 'STANDARD ANODIZED%'
	and p_size in (11, 49, 45, 6, 31, 12, 37, 41)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#33'
	and p_type not like 'MEDIUM ANODIZED%'
	and p_size in (41, 21, 37, 50, 48, 28, 40, 7)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#53'
	and p_type not like 'ECONOMY PLATED%'
	and p_size in (27, 43, 44, 18, 10, 28, 37, 33)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#51'
	and p_type not like 'MEDIUM BRUSHED%'
	and p_size in (41, 16, 13, 49, 37, 32, 47, 30)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#44'
	and p_type not like 'ECONOMY POLISHED%'
	and p_size in (2, 34, 48, 20, 1, 45, 31, 30)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#32'
	and p_type not like 'LARGE BURNISHED%'
	and p_size in (5, 12, 14, 24, 46, 45, 30, 35)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#15'
	and p_type not like 'PROMO BURNISHED%'
	and p_size in (8, 21, 10, 41, 33, 9, 43, 2)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#31'
	and p_type not like 'STANDARD ANODIZED%'
	and p_size in (2, 48, 9, 15, 7, 49, 18, 37)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#22'
	and p_type not like 'MEDIUM BURNISHED%'
	and p_size in (32, 42, 48, 40, 6, 50, 17, 24)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#51'
	and p_type not like 'PROMO BRUSHED%'
	and p_size in (12, 10, 32, 8, 20, 42, 29, 39)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#35'
	and p_type not like 'SMALL POLISHED%'
	and p_size in (35, 48, 4, 19, 22, 20, 17, 29)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#51'
	and p_type not like 'PROMO POLISHED%'
	and p_size in (11, 39, 42, 14, 49, 6, 28, 24)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#12'
	and p_type not like 'LARGE ANODIZED%'
	and p_size in (35, 29, 9, 14, 3, 15, 37, 16)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#21'
	and p_type not like 'STANDARD POLISHED%'
	and p_size in (29, 19, 9, 38, 44, 16, 28, 5)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#32'
	and p_type not like 'LARGE BRUSHED%'
	and p_size in (29, 46, 11, 33, 37, 32, 7, 38)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#42'
	and p_type not like 'MEDIUM POLISHED%'
	and p_size in (14, 46, 42, 31, 25, 50, 37, 22)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#14'
	and p_type not like 'STANDARD POLISHED%'
	and p_size in (39, 20, 30, 38, 28, 3, 14, 9)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#31'
	and p_type not like 'STANDARD ANODIZED%'
	and p_size in (37, 8, 45, 36, 6, 49, 46, 48)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
where
	...
	and p_brand <> 'Brand#51'
	and p_type not like 'SMALL POLISHED%'
	and p_size in (3, 25, 24, 38, 43, 47, 26, 35)
	and ps_suppkey not in (
		select
			s_suppkey
		from
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5988000 <= o_orderkey and o_orderkey < 5994016
);
delete from orders where 5988000 + 1000000000 <= o_orderkey and o_orderkey < 5994016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5982016 <= o_orderkey and o_orderkey < 5988000
);
delete from orders where 5982016 + 1000000000 <= o_orderkey and o_orderkey < 5988000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5976000 <= o_orderkey and o_orderkey < 5982016
);
delete from orders where 5976000 + 1000000000 <= o_orderkey and o_orderkey < 5982016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5970016 <= o_orderkey and o_orderkey < 5976000
);
delete from orders where 5970016 + 1000000000 <= o_orderkey and o_orderkey < 5976000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5964000 <= o_orderkey and o_orderkey < 5970016
);
delete from orders where 5964000 + 1000000000 <= o_orderkey and o_orderkey < 5970016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5958016 <= o_orderkey and o_orderkey < 5964000
);
delete from orders where 5958016 + 1000000000 <= o_orderkey and o_orderkey < 5964000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5952000 <= o_orderkey and o_orderkey < 5958016
);
delete from orders where 5952000 + 1000000000 <= o_orderkey and o_orderkey < 5958016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5946016 <= o_orderkey and o_orderkey < 5952000
);
delete from orders where 5946016 + 1000000000 <= o_orderkey and o_orderkey < 5952000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5940000 <= o_orderkey and o_orderkey < 5946016
);
delete from orders where 5940000 + 1000000000 <= o_orderkey and o_orderkey < 5946016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5934016 <= o_orderkey and o_orderkey < 5940000
);
delete from orders where 5934016 + 1000000000 <= o_orderkey and o_orderkey < 5940000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5928000 <= o_orderkey and o_orderkey < 5934016
);
delete from orders where 5928000 + 1000000000 <= o_orderkey and o_orderkey < 5934016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5922016 <= o_orderkey and o_orderkey < 5928000
);
delete from orders where 5922016 + 1000000000 <= o_orderkey and o_orderkey < 5928000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5916000 <= o_orderkey and o_orderkey < 5922016
);
delete from orders where 5916000 + 1000000000 <= o_orderkey and o_orderkey < 5922016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5910016 <= o_orderkey and o_orderkey < 5916000
);
delete from orders where 5910016 + 1000000000 <= o_orderkey and o_orderkey < 5916000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5904000 <= o_orderkey and o_orderkey < 5910016
);
delete from orders where 5904000 + 1000000000 <= o_orderkey and o_orderkey < 5910016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5898016 <= o_orderkey and o_orderkey < 5904000
);
delete from orders where 5898016 + 1000000000 <= o_orderkey and o_orderkey < 5904000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5892000 <= o_orderkey and o_orderkey < 5898016
);
delete from orders where 5892000 + 1000000000 <= o_orderkey and o_orderkey < 5898016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5886016 <= o_orderkey and o_orderkey < 5892000
);
delete from orders where 5886016 + 1000000000 <= o_orderkey and o_orderkey < 5892000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5880000 <= o_orderkey and o_orderkey < 5886016
);
delete from orders where 5880000 + 1000000000 <= o_orderkey and o_orderkey < 5886016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5874016 <= o_orderkey and o_orderkey < 5880000
);
delete from orders where 5874016 + 1000000000 <= o_orderkey and o_orderkey < 5880000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5868000 <= o_orderkey and o_orderkey < 5874016
);
delete from orders where 5868000 + 1000000000 <= o_orderkey and o_orderkey < 5874016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5862016 <= o_orderkey and o_orderkey < 5868000
);
delete from orders where 5862016 + 1000000000 <= o_orderkey and o_orderkey < 5868000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5856000 <= o_orderkey and o_orderkey < 5862016
);
delete from orders where 5856000 + 1000000000 <= o_orderkey and o_orderkey < 5862016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5850016 <= o_orderkey and o_orderkey < 5856000
);
delete from orders where 5850016 + 1000000000 <= o_orderkey and o_orderkey < 5856000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5844000 <= o_orderkey and o_orderkey < 5850016
);
delete from orders where 5844000 + 1000000000 <= o_orderkey and o_orderkey < 5850016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5838016 <= o_orderkey and o_orderkey < 5844000
);
delete from orders where 5838016 + 1000000000 <= o_orderkey and o_orderkey < 5844000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5832000 <= o_orderkey and o_orderkey < 5838016
);
delete from orders where 5832000 + 1000000000 <= o_orderkey and o_orderkey < 5838016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5826016 <= o_orderkey and o_orderkey < 5832000
);
delete from orders where 5826016 + 1000000000 <= o_orderkey and o_orderkey < 5832000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5820000 <= o_orderkey and o_orderkey < 5826016
);
delete from orders where 5820000 + 1000000000 <= o_orderkey and o_orderkey < 5826016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5814016 <= o_orderkey and o_orderkey < 5820000
);
delete from orders where 5814016 + 1000000000 <= o_orderkey and o_orderkey < 5820000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5808000 <= o_orderkey and o_orderkey < 5814016
);
delete from orders where 5808000 + 1000000000 <= o_orderkey and o_orderkey < 5814016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5802016 <= o_orderkey and o_orderkey < 5808000
);
delete from orders where 5802016 + 1000000000 <= o_orderkey and o_orderkey < 5808000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5796000 <= o_orderkey and o_orderkey < 5802016
);
delete from orders where 5796000 + 1000000000 <= o_orderkey and o_orderkey < 5802016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5790016 <= o_orderkey and o_orderkey < 5796000
);
delete from orders where 5790016 + 1000000000 <= o_orderkey and o_orderkey < 5796000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5784000 <= o_orderkey and o_orderkey < 5790016
);
delete from orders where 5784000 + 1000000000 <= o_orderkey and o_orderkey < 5790016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5778016 <= o_orderkey and o_orderkey < 5784000
);
delete from orders where 5778016 + 1000000000 <= o_orderkey and o_orderkey < 5784000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5772000 <= o_orderkey and o_orderkey < 5778016
);
delete from orders where 5772000 + 1000000000 <= o_orderkey and o_orderkey < 5778016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5766016 <= o_orderkey and o_orderkey < 5772000
);
delete from orders where 5766016 + 1000000000 <= o_orderkey and o_orderkey < 5772000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5760000 <= o_orderkey and o_orderkey < 5766016
);
delete from orders where 5760000 + 1000000000 <= o_orderkey and o_orderkey < 5766016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5754016 <= o_orderkey and o_orderkey < 5760000
);
delete from orders where 5754016 + 1000000000 <= o_orderkey and o_orderkey < 5760000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5748000 <= o_orderkey and o_orderkey < 5754016
);
delete from orders where 5748000 + 1000000000 <= o_orderkey and o_orderkey < 5754016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5742016 <= o_orderkey and o_orderkey < 5748000
);
delete from orders where 5742016 + 1000000000 <= o_orderkey and o_orderkey < 5748000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5736000 <= o_orderkey and o_orderkey < 5742016
);
delete from orders where 5736000 + 1000000000 <= o_orderkey and o_orderkey < 5742016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5730016 <= o_orderkey and o_orderkey < 5736000
);
delete from orders where 5730016 + 1000000000 <= o_orderkey and o_orderkey < 5736000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5724000 <= o_orderkey and o_orderkey < 5730016
);
delete from orders where 5724000 + 1000000000 <= o_orderkey and o_orderkey < 5730016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5718016 <= o_orderkey and o_orderkey < 5724000
);
delete from orders where 5718016 + 1000000000 <= o_orderkey and o_orderkey < 5724000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5712000 <= o_orderkey and o_orderkey < 5718016
);
delete from orders where 5712000 + 1000000000 <= o_orderkey and o_orderkey < 5718016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5706016 <= o_orderkey and o_orderkey < 5712000
);
delete from orders where 5706016 + 1000000000 <= o_orderkey and o_orderkey < 5712000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5700000 <= o_orderkey and o_orderkey < 5706016
);
delete from orders where 5700000 + 1000000000 <= o_orderkey and o_orderkey < 5706016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5694016 <= o_orderkey and o_orderkey < 5700000
);
delete from orders where 5694016 + 1000000000 <= o_orderkey and o_orderkey < 5700000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5688000 <= o_orderkey and o_orderkey < 5694016
);
delete from orders where 5688000 + 1000000000 <= o_orderkey and o_orderkey < 5694016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5682016 <= o_orderkey and o_orderkey < 5688000
);
delete from orders where 5682016 + 1000000000 <= o_orderkey and o_orderkey < 5688000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5676000 <= o_orderkey and o_orderkey < 5682016
);
delete from orders where 5676000 + 1000000000 <= o_orderkey and o_orderkey < 5682016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5670016 <= o_orderkey and o_orderkey < 5676000
);
delete from orders where 5670016 + 1000000000 <= o_orderkey and o_orderkey < 5676000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5664000 <= o_orderkey and o_orderkey < 5670016
);
delete from orders where 5664000 + 1000000000 <= o_orderkey and o_orderkey < 5670016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5658016 <= o_orderkey and o_orderkey < 5664000
);
delete from orders where 5658016 + 1000000000 <= o_orderkey and o_orderkey < 5664000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5652000 <= o_orderkey and o_orderkey < 5658016
);
delete from orders where 5652000 + 1000000000 <= o_orderkey and o_orderkey < 5658016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5646016 <= o_orderkey and o_orderkey < 5652000
);
delete from orders where 5646016 + 1000000000 <= o_orderkey and o_orderkey < 5652000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5640000 <= o_orderkey and o_orderkey < 5646016
);
delete from orders where 5640000 + 1000000000 <= o_orderkey and o_orderkey < 5646016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5634016 <= o_orderkey and o_orderkey < 5640000
);
delete from orders where 5634016 + 1000000000 <= o_orderkey and o_orderkey < 5640000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5628000 <= o_orderkey and o_orderkey < 5634016
);
delete from orders where 5628000 + 1000000000 <= o_orderkey and o_orderkey < 5634016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5622016 <= o_orderkey and o_orderkey < 5628000
);
delete from orders where 5622016 + 1000000000 <= o_orderkey and o_orderkey < 5628000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5616000 <= o_orderkey and o_orderkey < 5622016
);
delete from orders where 5616000 + 1000000000 <= o_orderkey and o_orderkey < 5622016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5610016 <= o_orderkey and o_orderkey < 5616000
);
delete from orders where 5610016 + 1000000000 <= o_orderkey and o_orderkey < 5616000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5604000 <= o_orderkey and o_orderkey < 5610016
);
delete from orders where 5604000 + 1000000000 <= o_orderkey and o_orderkey < 5610016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5598016 <= o_orderkey and o_orderkey < 5604000
);
delete from orders where 5598016 + 1000000000 <= o_orderkey and o_orderkey < 5604000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5592000 <= o_orderkey and o_orderkey < 5598016
);
delete from orders where 5592000 + 1000000000 <= o_orderkey and o_orderkey < 5598016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5586016 <= o_orderkey and o_orderkey < 5592000
);
delete from orders where 5586016 + 1000000000 <= o_orderkey and o_orderkey < 5592000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5580000 <= o_orderkey and o_orderkey < 5586016
);
delete from orders where 5580000 + 1000000000 <= o_orderkey and o_orderkey < 5586016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5574016 <= o_orderkey and o_orderkey < 5580000
);
delete from orders where 5574016 + 1000000000 <= o_orderkey and o_orderkey < 5580000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5568000 <= o_orderkey and o_orderkey < 5574016
);
delete from orders where 5568000 + 1000000000 <= o_orderkey and o_orderkey < 5574016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5562016 <= o_orderkey and o_orderkey < 5568000
);
delete from orders where 5562016 + 1000000000 <= o_orderkey and o_orderkey < 5568000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5556000 <= o_orderkey and o_orderkey < 5562016
);
delete from orders where 5556000 + 1000000000 <= o_orderkey and o_orderkey < 5562016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5550016 <= o_orderkey and o_orderkey < 5556000
);
delete from orders where 5550016 + 1000000000 <= o_orderkey and o_orderkey < 5556000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5544000 <= o_orderkey and o_orderkey < 5550016
);
delete from orders where 5544000 + 1000000000 <= o_orderkey and o_orderkey < 5550016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5538016 <= o_orderkey and o_orderkey < 5544000
);
delete from orders where 5538016 + 1000000000 <= o_orderkey and o_orderkey < 5544000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5532000 <= o_orderkey and o_orderkey < 5538016
);
delete from orders where 5532000 + 1000000000 <= o_orderkey and o_orderkey < 5538016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5526016 <= o_orderkey and o_orderkey < 5532000
);
delete from orders where 5526016 + 1000000000 <= o_orderkey and o_orderkey < 5532000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5520000 <= o_orderkey and o_orderkey < 5526016
);
delete from orders where 5520000 + 1000000000 <= o_orderkey and o_orderkey < 5526016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5514016 <= o_orderkey and o_orderkey < 5520000
);
delete from orders where 5514016 + 1000000000 <= o_orderkey and o_orderkey < 5520000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5508000 <= o_orderkey and o_orderkey < 5514016
);
delete from orders where 5508000 + 1000000000 <= o_orderkey and o_orderkey < 5514016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5502016 <= o_orderkey and o_orderkey < 5508000
);
delete from orders where 5502016 + 1000000000 <= o_orderkey and o_orderkey < 5508000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5496000 <= o_orderkey and o_orderkey < 5502016
);
delete from orders where 5496000 + 1000000000 <= o_orderkey and o_orderkey < 5502016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5490016 <= o_orderkey and o_orderkey < 5496000
);
delete from orders where 5490016 + 1000000000 <= o_orderkey and o_orderkey < 5496000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5484000 <= o_orderkey and o_orderkey < 5490016
);
delete from orders where 5484000 + 1000000000 <= o_orderkey and o_orderkey < 5490016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5478016 <= o_orderkey and o_orderkey < 5484000
);
delete from orders where 5478016 + 1000000000 <= o_orderkey and o_orderkey < 5484000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5472000 <= o_orderkey and o_orderkey < 5478016
);
delete from orders where 5472000 + 1000000000 <= o_orderkey and o_orderkey < 5478016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5466016 <= o_orderkey and o_orderkey < 5472000
);
delete from orders where 5466016 + 1000000000 <= o_orderkey and o_orderkey < 5472000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5460000 <= o_orderkey and o_orderkey < 5466016
);
delete from orders where 5460000 + 1000000000 <= o_orderkey and o_orderkey < 5466016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5454016 <= o_orderkey and o_orderkey < 5460000
);
delete from orders where 5454016 + 1000000000 <= o_orderkey and o_orderkey < 5460000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5448000 <= o_orderkey and o_orderkey < 5454016
);
delete from orders where 5448000 + 1000000000 <= o_orderkey and o_orderkey < 5454016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5442016 <= o_orderkey and o_orderkey < 5448000
);
delete from orders where 5442016 + 1000000000 <= o_orderkey and o_orderkey < 5448000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5436000 <= o_orderkey and o_orderkey < 5442016
);
delete from orders where 5436000 + 1000000000 <= o_orderkey and o_orderkey < 5442016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5430016 <= o_orderkey and o_orderkey < 5436000
);
delete from orders where 5430016 + 1000000000 <= o_orderkey and o_orderkey < 5436000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5424000 <= o_orderkey and o_orderkey < 5430016
);
delete from orders where 5424000 + 1000000000 <= o_orderkey and o_orderkey < 5430016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5418016 <= o_orderkey and o_orderkey < 5424000
);
delete from orders where 5418016 + 1000000000 <= o_orderkey and o_orderkey < 5424000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5412000 <= o_orderkey and o_orderkey < 5418016
);
delete from orders where 5412000 + 1000000000 <= o_orderkey and o_orderkey < 5418016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5406016 <= o_orderkey and o_orderkey < 5412000
);
delete from orders where 5406016 + 1000000000 <= o_orderkey and o_orderkey < 5412000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5400000 <= o_orderkey and o_orderkey < 5406016
);
delete from orders where 5400000 + 1000000000 <= o_orderkey and o_orderkey < 5406016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5394016 <= o_orderkey and o_orderkey < 5400000
);
delete from orders where 5394016 + 1000000000 <= o_orderkey and o_orderkey < 5400000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5388000 <= o_orderkey and o_orderkey < 5394016
);
delete from orders where 5388000 + 1000000000 <= o_orderkey and o_orderkey < 5394016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5382016 <= o_orderkey and o_orderkey < 5388000
);
delete from orders where 5382016 + 1000000000 <= o_orderkey and o_orderkey < 5388000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5376000 <= o_orderkey and o_orderkey < 5382016
);
delete from orders where 5376000 + 1000000000 <= o_orderkey and o_orderkey < 5382016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5370016 <= o_orderkey and o_orderkey < 5376000
);
delete from orders where 5370016 + 1000000000 <= o_orderkey and o_orderkey < 5376000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5364000 <= o_orderkey and o_orderkey < 5370016
);
delete from orders where 5364000 + 1000000000 <= o_orderkey and o_orderkey < 5370016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5358016 <= o_orderkey and o_orderkey < 5364000
);
delete from orders where 5358016 + 1000000000 <= o_orderkey and o_orderkey < 5364000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5352000 <= o_orderkey and o_orderkey < 5358016
);
delete from orders where 5352000 + 1000000000 <= o_orderkey and o_orderkey < 5358016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5346016 <= o_orderkey and o_orderkey < 5352000
);
delete from orders where 5346016 + 1000000000 <= o_orderkey and o_orderkey < 5352000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5340000 <= o_orderkey and o_orderkey < 5346016
);
delete from orders where 5340000 + 1000000000 <= o_orderkey and o_orderkey < 5346016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5334016 <= o_orderkey and o_orderkey < 5340000
);
delete from orders where 5334016 + 1000000000 <= o_orderkey and o_orderkey < 5340000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5328000 <= o_orderkey and o_orderkey < 5334016
);
delete from orders where 5328000 + 1000000000 <= o_orderkey and o_orderkey < 5334016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5322016 <= o_orderkey and o_orderkey < 5328000
);
delete from orders where 5322016 + 1000000000 <= o_orderkey and o_orderkey < 5328000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5316000 <= o_orderkey and o_orderkey < 5322016
);
delete from orders where 5316000 + 1000000000 <= o_orderkey and o_orderkey < 5322016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5310016 <= o_orderkey and o_orderkey < 5316000
);
delete from orders where 5310016 + 1000000000 <= o_orderkey and o_orderkey < 5316000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5304000 <= o_orderkey and o_orderkey < 5310016
);
delete from orders where 5304000 + 1000000000 <= o_orderkey and o_orderkey < 5310016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5298016 <= o_orderkey and o_orderkey < 5304000
);
delete from orders where 5298016 + 1000000000 <= o_orderkey and o_orderkey < 5304000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5292000 <= o_orderkey and o_orderkey < 5298016
);
delete from orders where 5292000 + 1000000000 <= o_orderkey and o_orderkey < 5298016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5286016 <= o_orderkey and o_orderkey < 5292000
);
delete from orders where 5286016 + 1000000000 <= o_orderkey and o_orderkey < 5292000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5280000 <= o_orderkey and o_orderkey < 5286016
);
delete from orders where 5280000 + 1000000000 <= o_orderkey and o_orderkey < 5286016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5274016 <= o_orderkey and o_orderkey < 5280000
);
delete from orders where 5274016 + 1000000000 <= o_orderkey and o_orderkey < 5280000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5268000 <= o_orderkey and o_orderkey < 5274016
);
delete from orders where 5268000 + 1000000000 <= o_orderkey and o_orderkey < 5274016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5262016 <= o_orderkey and o_orderkey < 5268000
);
delete from orders where 5262016 + 1000000000 <= o_orderkey and o_orderkey < 5268000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5256000 <= o_orderkey and o_orderkey < 5262016
);
delete from orders where 5256000 + 1000000000 <= o_orderkey and o_orderkey < 5262016 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5250016 <= o_orderkey and o_orderkey < 5256000
);
delete from orders where 5250016 + 1000000000 <= o_orderkey and o_orderkey < 5256000 + 1000000000;
...
insert into orders (
    select o_orderkey + 1000000000,
           ...
           (select sum(L_QUANTITY * P_RETAILPRICE * (1+L_TAX) * (1-L_DISCOUNT)) from lineitem, part where l_orderkey = o_orderkey and P_PARTKEY = L_PARTKEY), o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment
    from orders
    where 5244000 <= o_orderkey and o_orderkey < 5250016
);
delete from orders where 5244000 + 1000000000 <= o_orderkey and o_orderkey < 5250016 + 1000000000;
